...
<head>
    ...
    <script src="../js/game-bg3.js"></script>
</head>
...
<div class="main-container">
    <div class="left-column">
        ...
        <div class="thumbnails">
            ...
            <img class="thumb" src="../src/Capas/bg3/gameplay4.jpg" alt="Thumbnail 5" onclick="changeImage('../src/Capas/bg3/gameplay4.jpg', this)">
        </div>
    </div>
    ...
    <div class="right-column">
        <div class="game-info">
            ...
            <p>Desenvolvedor: <strong>Larian Studios</strong></p>
