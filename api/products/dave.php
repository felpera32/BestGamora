...
<head>
    ...
    <title>Dave The Diver</title>
    <link rel="stylesheet" href="../css/games.css">
    <script src="../js/game-dave.js"></script>
</head>
    ...
    <div class="main-container">
        <div class="left-column">
            ...
            <div class="thumbnails">
                ...
                <img class="thumb" src="../src/Capas/diver/gameplay4.jpg" onclick="changeImage('../src/Capas/diver/gameplay4.jpg', this)">
            </div>
        </div>
        ...
        <div class="right-column">
            <div class="game-info">
                ...
                <p>Desenvolvedor: <strong>MINTROCKET</strong></p>
